...
class DateFinder(object):
    ...
    DIGITS_MODIFIER_PATTERN = '\d+st|\d+th|\d+rd|first|second|third|fourth|fifth|sixth|seventh|eighth|nineth|tenth|next|last|primero|segundo|tercero|cuarto|quinto|sexto|séptimo|octavo|noveno|décimo|siguiente|último'
    DIGITS_PATTERN = '\d+'
    DAYS_PATTERN = 'monday|tuesday|wednesday|thursday|friday|saturday|sunday|mon|tue|tues|wed|thur|thurs|fri|sat|sun|lunes|martes|miércoles|jueves|viernes|sábado|domingo|lun|mar|mie|jue|vie|sa|do'
    MONTHS_PATTERN = 'january|february|march|april|may|june|july|august|september|october|november|december|jan|feb|mar|apr|may|jun|jul|aug|sep|sept|oct|nov|dec|enero|febrero|marzo|abril|mayo|junio|julio|agosto|septiembre|octubre|noviembre|diciembre|ene|feb|mar|abr|may|jun|jul|ago|sep|oct|nov|dic'
    ...
    EXTRA_TOKENS_PATTERN = 'due|by|on|standard|daylight|savings|time|date|of|to|until|z|at|t|a|por|en|día|horario|tiempo|fecha|de|al|hasta|del|las|desde'

    ## TODO: Get english numbers?
    ## http://www.rexegg.com/regex-trick-numbers-in-english.html

    RELATIVE_PATTERN = 'before|after|next|last|ago|antes|después|siguiente|último|hace'
    TIME_SHORTHAND_PATTERN = 'noon|midnight|today|yesterday|mediodía|medianoche|hoy|ayer'
    UNIT_PATTERN = 'second|minute|hour|day|week|month|year|segundo|minuto|hora|día|semana|mes|año'
